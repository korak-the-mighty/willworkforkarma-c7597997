...
const About = () => {
  ...
  return (
    <Layout fullWidth>
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-24 md:pt-40 md:pb-32 grid grid-cols-1 md:grid-cols-[minmax(260px,32%)_1fr] gap-12 md:gap-20">
        ...
        <div>
          <section className="py-12 md:py-16 space-y-6">
            <p className="font-heading text-3xl md:text-5xl tracking-tight text-foreground leading-[1.15] max-w-3xl">
              {main.headline}
            </p>
