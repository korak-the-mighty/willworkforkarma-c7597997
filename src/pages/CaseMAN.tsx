    ...
    <Layout fullWidth theme={{ bg: "#0f0c0c" }}>
      <div className="text-white">
        ...
        <section className="relative min-h-screen w-full">
          <img src="https://pub-d695aab3039745849234fbcc82eb82bb.r2.dev/MAN-image-3.webp" loading="eager" fetchPriority="high" className="absolute inset-0 w-full h-full object-cover" alt="" />
