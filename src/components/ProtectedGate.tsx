...
export function ProtectedGate({ slug, onSuccess, onClose }: Props) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-black/80 backdrop-blur-sm" onClick={() => { document.body.style.overflow = ''; document.body.style.position = ''; document.documentElement.style.overflow = ''; onClose(); }} />
