...
export const cases: Case[] = [
  {
    ...
    coverVariant: "grid",
    subline: "Brand and digital presence for the future of charging",
    area: "Brand & Digital",
    client: "ABB",
  ...
  },
  {
    ...
    coverImage: "/placeholder.svg",
    coverVariant: "grid",
    subline: "One narrative to replace five competing decks",
    area: "Strategy & Narrative",
  ...
  },
  {
    ...
    subline: "An identity built from observation, not aspiration",
    area: "Brand Identity",
  ...
  },
  {
    ...
    coverImage: "/placeholder.svg",
    coverVariant: "texture",
    subline: "Making car maintenance feel like progress, not chores",
    area: "Product & UX",
